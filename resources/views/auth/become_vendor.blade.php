...
@include('frontend.body.header')
 ...
 <main class="main pages">
        ...
        <div class="page-content pt-150 pb-150">
         ...
         <p class="mb-30">Already a vendor? <a href="{{ route('vendor.login') }}">VendorLogin</a></p>
                                        </div> 
    ...
    <div class="form-group">
        <input type="text" id="name" required="" name="username" placeholder="Username" />
    </div>
    <div class="form-group">
        <input type="email"  id="email" required="" name="email" placeholder="Email" />
    </div>
    <div class="form-group">
        <input type="text" id="name" required="" name="phone" placeholder="Phone" />
    </div>
    ...
    @include('frontend.body.footer')  <!-- Preloader Start -->
