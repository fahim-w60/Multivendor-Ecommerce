                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            <h3 class="title-detail" id="pname"><a href="shop-product-right.html" class="text-heading"></a></h3>
                            ...
                            <div class="attr-detail attr-size mb-30" id="colorArea">
                                <strong class="mr-10" style="width:60px;">Color : </strong>
                                        <select class="form-control unicase-form-control" id="size" name="color">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul>
                                        ...
                                        <li class="mb-5">Stock <span class="badge badge-fill badge-success" id="availabe" style="background-color: green;color:white;"> Jun 4.2022</span></li>
                                        <li class="mb-5">Stock <span class="badge badge-fill badge-success" id="unavailable" style="background-color: red;color:white;"></span></li>
                                    </ul>
