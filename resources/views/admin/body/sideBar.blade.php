            ...
            <li>
				...
				<li>
					...
					<ul>
						...
						<li> <a href="{{route('add.product')}}"><i class="bx bx-right-arrow-alt"></i>Manage Product</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						...
						<li> <a href="{{route('add.slider')}}"><i class="bx bx-right-arrow-alt"></i>Manage Slider</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						...
						<li> <a href="{{route('add.banner')}}"><i class="bx bx-right-arrow-alt"></i>Manage Banner</a>
						</li>
					</ul>
				</li>
